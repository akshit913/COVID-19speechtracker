...
public class MicrophoneCapture : MonoBehaviour
{
    ...
    **/
    const string PROJECT_ID = "nuicovidbot-nhyqqr";
    const string email = "akshitmehta@nuicovidbot-nhyqqr.iam.gserviceaccount.com";
    /* Make sure it is in the Assets Folder so that this is only the name */
    string certPath = "nuicovidbot-nhyqqr-66a272b9f62d.p12";

    // This needs to be changed to access you script
    public chaddBehaviour myScript;
    ...
    void Start()
    {
        ...
        this.myScript = GameObject.FindObjectOfType(typeof(chaddBehaviour)) as chaddBehaviour;
